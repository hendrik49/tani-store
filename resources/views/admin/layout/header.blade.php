...
<head>
    ...
    <link href="{{ URL::to('assets/plugins/jquery-datatable/skin/bootstrap/css/dataTables.bootstrap.css') }}" rel="stylesheet">
...
<body class="theme-red">
    ...
    <nav class="navbar-admin">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{{ url('/') }}"><p><img src="{{ asset('img_product/logo.png') }}" width="30" height="30" alt="Logo">Herbal Store(Administrator) </p></a>
            </div>
    ...
    <section>
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="legal">
                <div class="copyright">
                    &copy; 2017 <a href="javascript:void(0);">Herbal Store</a>.
                </div>
                <div class="version">
                    <b>Version: </b> 1.0.4
                </div>
