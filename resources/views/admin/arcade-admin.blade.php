...
<head>
    ...
    <title>Herbal Store - Project</title>
    <!-- Favicon-->
    ...
    <nav class="navbar-admin">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{{ url('/') }}">Store Project</a>
            </div>
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li>
                        <a href="{{ url('/action') }}">
                            <i class="material-icons">videoproduct_asset</i>
                            <span>Action</span>
                        </a>
                    </li>
                    <li class="active">
        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <a href="{{ url('/addproductcasino') }}" ><button type="button" class="btn bg-deep-orange waves-effect font-italic"><h2>Add Products</h2></button></a>
                            <h2><br/>
                                Category : Arcade
                            </h2>
                        </div>
